...
// resourcesConnectionrefusedHtml reads file data from disk. It returns an error on failure.
func resourcesConnectionrefusedHtml() (*asset, error) {
	path := "C:\\Users\\john\\go\\src\\github.com\\jkk111\\indigo\\resources\\ConnectionRefused.html"
	name := "resources/ConnectionRefused.html"
...
// resourcesServiceunavailableHtml reads file data from disk. It returns an error on failure.
func resourcesServiceunavailableHtml() (*asset, error) {
	path := "C:\\Users\\john\\go\\src\\github.com\\jkk111\\indigo\\resources\\ServiceUnavailable.html"
	name := "resources/ServiceUnavailable.html"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
// resourcesAdminIndexHtml reads file data from disk. It returns an error on failure.
func resourcesAdminIndexHtml() (*asset, error) {
	path := "C:\\Users\\john\\go\\src\\github.com\\jkk111\\indigo\\resources\\admin\\index.html"
	name := "resources/admin/index.html"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
// resourcesSetupSql reads file data from disk. It returns an error on failure.
func resourcesSetupSql() (*asset, error) {
	path := "C:\\Users\\john\\go\\src\\github.com\\jkk111\\indigo\\resources\\setup.sql"
	name := "resources/setup.sql"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
